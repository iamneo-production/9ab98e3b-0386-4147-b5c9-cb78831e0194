...
select agency,count(*) as ep_cnt from hr_department 
group by agency;
...
select "Position Title",count(*) as emp_cnt from hr_department group by "Position Title";
...
-- write an sql query to count the number of employees whose period pay rate is less then 50000   
>>>>>>> 5fdfb4f7ecbddc93b1d3e6f8c56a300959b8ef87
>>>>>>> main
